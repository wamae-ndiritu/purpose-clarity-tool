...
const Hero = () => {
  return (
    <section className='py-16 bg-white'>
      <h1 className='text-3xl text-center text-maroon-red font-semibold mb-4'>
      ...
      <div className='px-8 grid grid-cols-1  md:grid-cols-3 gap-8 flex items-center justify-center'>
        ...
        <div className='col-span-1 space-y-6'>
          ...
          >
            <span className='w-8 h-8 bg-white border border-red-700 rounded flex items-center justify-center text-gray-800 font-semibold mr-2 hover:text-red-700'>
              1
            </span>
            <h6 className='hover:text-red-700'>Who are you?</h6>
          </Link>
          {/* Question 2 */}
          <Link
          ...
          >
            ...
            <h6 className='hover:text-red-700'>What do you do well?</h6>
          </Link>
          {/* Question 3 */}
          <Link
          ...
          >
            ...
            <h6 className='hover:text-red-700'>What do you love to do?</h6>
          </Link>
          {/* Question 4 */}
          <Link
          ...
          >
            ...
            <h6 className='hover:text-red-700'>Whom do you intend to serve?</h6>
          </Link>
        </div>
        ...
        <div className='col-span-1 space-y-6'>
          ...
          >
            ...
            <h6 className='hover:text-red-700'>
