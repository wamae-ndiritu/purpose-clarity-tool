  ...
  return (
    <div>
      <p style={{ marginLeft: "10px" }}>
        ...
        <br /> The purpose statement must be a concise, memorable and inspiring
        decla- ration.I will use my purpose,
        ...
        <br />
        viduals and organisations". The transformational dimension includes the
